...
public class TestFiles {
    ...
    public TestFiles(TestFileTree tree, FileTestQueries fileQueries,
                     Comparator<TreeDto> treeDtoComp, Comparator<FileViewRecord> fileViewRecordComp) {
        this.tree = tree;
...
//    }
    ...
    public NavigableSet<FileViewRecord> fetchFileViewRecordsLinkedTo(String treePathStr) {
        ...
        return fetchFileViewRecordsLinkedTo( treeDto );

    }

    // uses objectId from treeDto, does not consider path, userId pulled from tree provided to constructor
    public NavigableSet<FileViewRecord> fetchFileViewRecordsLinkedTo(TreeDto treeDto) {
    ...
    public NavigableSet<TreeDto> fetchObjectsLinkedTo(FileRecord fileViewRecord) {
    ...
    private record ObjectFileLink(TreeDto treeDto, FileViewRecord fileViewRecord) {
    }
